...
def remove_from_faiss(faiss_db, file_name):
    ...
    # Remove keys from the FAISS index and the docstore
    numeric_ids = []
...
# json_file_path = './data/chunked_data_all_folders_with_links.json'
# doc = json_to_documents(json_file_path)
# db = FAISS.from_documents(doc, embeddings)
# save_faiss(db,"./data/vector_store/faiss_index", "./data/vector_store/faiss_meta")